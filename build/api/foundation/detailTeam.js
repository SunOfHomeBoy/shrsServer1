...
function detailTeam(req, res, parameters) {
    return __awaiter(this, void 0, void 0, function () {
        var callback;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, foundation_1.schema.team.findById(parameters.teamID)];
                case 1:
                    callback = _a.sent();
                    ...
                    return [2, foundation_1.render({
                            code: 200, msg: '', data: {
                                ...
                                submitTime: foundation_1.utils.formatDate('YYYY-MM-DD HH:mm:ss', callback.submitTime)
                            }
                        })];
            }
        });
