...
function editFulltime(req, res, parameters) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    parameters.resumeType = 'FULLTIME';
                    return [4, foundation_1.schema.member.existsByID(parameters.openID)];
                case 1:
                    member = _a.sent();
                    if (!member) {
                        return [2, foundation_1.render({ code: 2018, msg: 'Invalid Member Information' })];
                    }
                    return [4, foundation_1.schema.resume.saveResume(parameters)];
                case 2:
                    callback = _a.sent();
                    if (!callback) {
