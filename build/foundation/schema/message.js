...
var schemaMessage = (function (_super) {
    __extends(schemaMessage, _super);
    function schemaMessage() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    schemaMessage.prototype.init = function () {
        return {
            name: 'message',
            schema: schema_1.newSchema({
                ...
                messageData: schema_1.Mixed
            })
        };
    };
    schemaMessage.prototype.sms = function (parameters) {
    ...
    schemaMessage.prototype.push = function (parameters) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.save({
                        _id: utils_1["default"].uuid(),
...
exports["default"] = new schemaMessage();
