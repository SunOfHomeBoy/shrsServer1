...
function rebateMember(req, res, parameters) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4, foundation_1.schema.member.findByIdAndUpdate(parameters.openID, { rebate: memberInfo })];
                case 2:
                    callback = _a.sent();
                    if (foundation_1.utils.empty(callback)) {
                        return [2, foundation_1.render({ code: 2020, msg: 'Save Parameters Failth' })];
                    }
                    return [2, foundation_1.render({ code: 200, msg: '', data: foundation_1.utils.openIDEncode(memberInfo.openID) })];
            }
        });
    });
}
exports["default"] = rebateMember;
