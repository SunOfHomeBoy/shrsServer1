...
function statusResume(req, res, parameters) {
    return __awaiter(this, void 0, void 0, function () {
        var member, fulltime, parttime;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (foundation_1.utils.empty(member)) {
                        return [2, foundation_1.render({ code: 2101, msg: 'Invalid User Information' })];
                    }
                    return [4, foundation_1.schema.resume.findFulltime(parameters.openID)];
                case 2:
                    fulltime = _a.sent();
                    return [4, foundation_1.schema.resume.findParttime(parameters.openID)];
                case 3:
                    parttime = _a.sent();
                    return [2, foundation_1.render({
                            code: 200, msg: '', data: {
                                hasFulltime: foundation_1.utils.empty((fulltime || {}).realname) === false,
                                ...
                                hasParttime: foundation_1.utils.empty((parttime || {}).realname) === false,
