...
export default async function editArticle(req: request, res: response, parameters: any): Promise<IResult> {
        if (utils.empty(parameters.articleID) || utils.empty(parameters.title)) {
