...
function signin(req, res, parameters) {
    return __awaiter(this, void 0, void 0, function () {
        var username, password, memberInfo, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    username = encodeURIComponent(parameters.user);
                    password = foundation_1.utils.cryptoPassword(parameters.password);
                ...
                case 1:
                    ...
                    if (!foundation_1.utils.empty(memberInfo)) {
                        ...
                        return [2, foundation_1.render({ code: 200, msg: '', data: memberInfo })];
                    }
