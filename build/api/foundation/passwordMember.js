...
function passwordMember(req, res, parameters) {
    return __awaiter(this, void 0, void 0, function () {
        var memberInfo, cryptoPassword, callback;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    parameters.openID = foundation_1.utils.openIDDecode(parameters.openID);
                    if (foundation_1.utils.empty(parameters.oldPassword) || foundation_1.utils.empty(parameters.newPassword) || foundation_1.utils.empty(parameters.confirmPass)) {
                        return [2, foundation_1.render({ code: 2002, msg: 'Password contains at least 6 characters' })];
                    }
                    ...
                    if (/[A-Z]/.test(parameters.newPassword) === false) {
                        return [2, foundation_1.render({ code: 2003, msg: 'Password must contain uppercase characters' })];
                    }
                    if (/[a-z]/.test(parameters.newPassword) === false) {
                        return [2, foundation_1.render({ code: 2004, msg: 'Password must contain lowercase characters' })];
                    }
                ...
                case 1:
                    ...
                    cryptoPassword = foundation_1.utils.cryptoPassword(parameters.oldPassword);
                    if (cryptoPassword !== memberInfo.password) {
                        return [2, foundation_1.render({ code: 2019, msg: 'Invalid Parameters' })];
                    }
                    memberInfo.password = foundation_1.utils.cryptoPassword(parameters.newPassword);
                    return [4, foundation_1.schema.member.save(memberInfo)];
                case 2:
                    callback = _a.sent();
                    if (!callback) {
                        return [2, foundation_1.render({ code: 2020, msg: '' })];
                    }
...
exports["default"] = passwordMember;
