...
function addArticle(req, res, parameters) {
    return __awaiter(this, void 0, void 0, function () {
        var fields, _i, fields_1, key, callback;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fields = ['openID', 'teamCompany', 'teamNumber', 'teamPlace', 'teamDate', 'teamBudget', 'teamConnect'];
                    for (_i = 0, fields_1 = fields; _i < fields_1.length; _i++) {
                        key = fields_1[_i];
                        if (foundation_1.utils.empty(parameters[key])) {
                    ...
                    return [4, foundation_1.schema.team.insert(parameters)];
                case 1:
                    callback = _a.sent();
                    if (!callback) {
