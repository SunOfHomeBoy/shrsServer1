...
function searchImgList(req, res, parameters) {
                ...
                case 0:
                    ...
                    if (parameters.Publish) {
                        filter.where.publish = {
                            $gt: foundation_1.utils.beforeToday(parameters.Publish)
                        };
                    }
                    return [4, foundation_1.schema.imgList.findPage(filter)];
                case 1:
                    document = _a.sent();
