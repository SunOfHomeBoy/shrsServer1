...
function searchTeam(req, res, parameters) {
    return __awaiter(this, void 0, void 0, function () {
        var openID, filter, document;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (foundation_1.utils.empty(parameters.openID)) {
                        return [2, foundation_1.render({ code: 2019, msg: '' })];
                    }
                    ...
                    if (foundation_1.utils.empty(parameters.teamPublish) === false) {
                        filter.where.submitTime = {
                            $gt: foundation_1.utils.beforeToday(parameters.teamPublish)
                        };
                    }
                    if (foundation_1.utils.empty(parameters.teamStatus) === false) {
                        filter.where.teamStatus = (parameters.teamStatus === 2);
                    }
                    return [4, foundation_1.schema.team.findPage(filter)];
                case 1:
                    document = _a.sent();
                    document.items = foundation_1.utils.forEach(document.items, function (e) {
                        return {
                            ...
                            teamSubmit: foundation_1.utils.formatDate('YYYY-MM-DD HH:mm:ss', e.submitTime)
                        };
                    });
