...
function editArticle(req, res, parameters) {
    return __awaiter(this, void 0, void 0, function () {
        var callback;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (foundation_1.utils.empty(parameters.articleID) || foundation_1.utils.empty(parameters.title)) {
                        return [2, foundation_1.render({ code: 2019, msg: 'Invalid Parameters' })];
                    }
                    return [4, foundation_1.schema.article.saveArticle(parameters)];
                case 1:
                    callback = _a.sent();
