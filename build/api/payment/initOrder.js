...
function initOrder(req, res, parameters) {
                ...
                case 1:
                    ...
                    return [2, foundation_1.render({
                            code: 200, msg: '', data: {
                                ...
                                price: memberInfo.rebateStatus ? foundation_1.schema.order.disPrice : foundation_1.schema.order.allPrice,
                                vedio: foundation_1.schema.order.itvPrice,
                                passwordPay: foundation_1.utils.empty(memberInfo.passwordPay) === false
                            }
                        })];
            }
        });
