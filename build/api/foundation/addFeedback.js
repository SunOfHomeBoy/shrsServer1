...
function addFeedback(req, res, parameters) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (foundation_1.utils.empty(parameters.openID) || foundation_1.utils.empty(parameters.content)) {
                        return [2, foundation_1.render({ code: 2019, msg: 'Invalid Parameters' })];
                    }
                    return [4, foundation_1.schema.comment.insert({
