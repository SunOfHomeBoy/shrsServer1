...
function privacyResume(req, res, parameters) {
    return __awaiter(this, void 0, void 0, function () {
        var member, document, callback;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4, foundation_1.schema.resume.saveResume(document)];
                case 2:
                    callback = _a.sent();
                    if (!callback) {
